    ...
    <section class="min-h-screen p-4 bg-gray-100 md:p-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="p-6 bg-white rounded-b-lg shadow-md md:p-8">
                ...
                <form action="{{ route('admin.blog-category.update', $category) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" value="{{ old('slug', $category->slug) }}"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:border-transparent @error('slug') border-red-500 @enderror"

...
@section('title', 'Fund | Edit Slider')
@include('backend.component.front-type')
@section('content')
<div class="p-6 bg-gray-100 min-h-screen">

    <div class="bg-white rounded-xl shadow-md p-6">
        <h2 class="text-xl font-bold mb-6">Edit Slider</h2>
        ...
        <form action="{{ route('admin.slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="title1" value="{{ old('title1', $slider->title1) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="title2" value="{{ old('title2', $slider->title2) }}" 
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-200" required>
                </div>

                <div class="md:col-span-2">
                    <label class="block mb-2 font-medium">Description</label>
                    <textarea name="description" rows="4" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-200">{{ old('description', $slider->description) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    @if($slider->image)
                        <img src="{{ asset('storage/'.$slider->image) }}" class="w-32 h-32 object-cover mt-2 rounded-lg">
                    @endif
                </div>

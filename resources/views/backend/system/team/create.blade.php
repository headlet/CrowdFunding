        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="p-6 bg-white border-b rounded-t-lg shadow-md">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Add New Team Member</h2>
                        <p class="mt-1 text-sm text-gray-500">Create a new team member profile</p>
                    </div>
                ...
                <form action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="pb-6 border-b">
                        ...
                        <div>
                            ...
                            <textarea name="bio" rows="4"
                                ...
                                placeholder="Write a brief biography about the team member">{{ old('bio') }}</textarea>
                            @error('bio')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex flex-col gap-3 pt-6 border-t sm:flex-row">
                        <button type="submit"
                            ...
                            <i class="mr-2 fas fa-save"></i>Save Team Member
                        </button>
                        <a href="{{ route('admin.team.index') }}"

<div
    ...
    <nav class="flex flex-col flex-1 gap-2 p-4 overflow-y-auto">
        ...
        <div class="my-2 border-t border-green-200/30"></div>
        ...
        @endpermission
        @permission('admin.donation.index')
        ...
        @endpermission
        @permission('admin.gallery.index')
        ...
        @endpermission
        @permission('admin.role-permission.index')
            <a href="{{ route('admin.role-permission.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all {{ request()->routeIs('admin.role-permission.*') ? 'bg-green-700' : 'hover:bg-green-700' }}">
                <i class="flex-shrink-0 w-5 text-lg fas fa-users"></i>
                <span class="texts whitespace-nowrap">Role</span>
            </a>
        @endpermission
    </nav>

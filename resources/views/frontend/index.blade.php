            ...
            <div class="col-xl-6">
                <div class="about-wrap4">
                    <div class="title-area mb-30">
                        ...
                        <p class="sec-text">Our secure online donation platform allows you to make contributions quickly and safely. Choose from various payment methods and set up one-time or recurring donations with ease. Your support helps us continue our mission.</p>
                    </div>
                    ...
                    <div class="btn-wrap style2 mt-40">
                        <a href="about.html" class="th-btn">About More<div class="icon"><i class="fa-solid fa-arrow-up-right ms-2"></i></div></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class=" overflow-hidden" data-bg-src="{{asset('img/bg/gray-bg3.png')}}" id="donation-sec">
    ...
    <div class="container th-container2">
        <div class="slider-area">
            <div class="swiper th-slider has-shadow" id="donationSlider4" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}, "autoHeight": "true"}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="donation-card style4" data-theme-color="">
                            ...
                            <div class="box-content">
                                ...
                                <a href="{{route('donation-details')}}" class="th-btn style6">Donate Now <i class="fas fa-arrow-up-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card style3">
                    ...
                    <div class="box-content">
                        ...
                        <p class="box-text">Share stories and experiences from current volunteers to inspire others to join.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
...
<div class="space-bottom overflow-hidden">
    <div class="container-fluid p-0">
        <div class="swiper th-slider marquee-slider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":"auto"}},"autoplay":{"delay":0,"disableOnInteraction":false},"noSwiping":"true","speed":10000,"spaceBetween":20}'>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
...
<div class="overflow-hidden campaign-area-1 space-top bg-gray" data-bg-src="{{asset('img/bg/gray-bg4.png')}}">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <div class="sec-btn">
                    <a href="contact.html" class="th-btn">Contact Us Now<i class="fas fa-arrow-up-right ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="campaign-wrap1">
            ...
            <div class="donation-form-v1">
                ...
                <p>Our secure online donation platform allows you to make contributions quickly and safely. Choose from various payment methods and set up one-time.exactly.</p>
                <div class="donation-card_progress-wrap">
                    <div class="progress">
                        <div class="progress-bar" style="width: 85%;">
                        </div>
...
<section class="space team-area-2">
    ...
    <div class="container">
        ...
        <div class="slider-area">
            ...
            <button data-slider-prev="#teamSlider2" class="slider-arrow slider-prev"><i class="far fa-arrow-left"></i></button>
            <button data-slider-next="#teamSlider2" class="slider-arrow slider-next"><i class="far fa-arrow-right"></i></button>
        </div>
    </div>
</section><!--==============================
Story Area  
    ...
    <div class="container">
        <div class="row gy-40 gx-80">
            <div class="col-lg-4 align-self-end">
                <div class="swiper th-slider testi-thumb-slider4" data-slider-options='{"effect":"fade","loop":false}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
            ...
            <div class="col-lg-8">
                <div class="testi-wrap4">
                    <div class="title-area">
                        ...
                        <h2 class="sec-title text-white">What People Say About Our Charity</h2>
                    </div>
                    <div class="testi-slider4">
                        <div class="swiper th-slider testimonial-slider4" id="testiSlide4" data-slider-options='{"loop":false,"paginationType":"progressbar","effect":"fade", "autoHeight": "true", "thumbs":{"swiper":".testi-thumb-slider4"}}'>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
            ...
            <div class="col-12">
                <div class="event-card2">
                    ...
                    <div class="box-content">
                        ...
                        <h3 class="box-title"><a href="https://html.themehour.net/donat/demo/event-details.html">Give the blessings of your hun boa to children's</a></h3>
                        <p class="box-text">Our secure online donation platform allows you to make contributions quickly and safely. Choose from various payment methods and set up one-time.exactly.</p>
                        <div class="event-content">
                            <div class="media-left">
                                <h5 class="event-box-subtitle">Venue</h5>
                                <p class="event-location">350 5th AveNew York, NY 118 United States</p>
                                <a href="https://html.themehour.net/donat/demo/event-details.html" class="th-btn">Event Details<i class="fas fa-arrow-up-right ms-2"></i></a>
                            </div>
            ...
            <div class="col-12">
                <div class="event-card2">
                    ...
                    <div class="box-content">
                        ...
                        <h3 class="box-title"><a href="https://html.themehour.net/donat/demo/event-details.html">Providing Access to safe water, sanitation</a></h3>
                        <p class="box-text">Our secure online donation platform allows you to make contributions quickly and safely. Choose from various payment methods and set up one-time.exactly.</p>
                        <div class="event-content">
                            <div class="media-left">
                                <h5 class="event-box-subtitle">Venue</h5>

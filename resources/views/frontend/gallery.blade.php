            ...
            <div class="col-md-6 col-xxl-auto col-lg-4 filter-item">
                <div class="gallery-card">
                    <div class="gallery-img">
                        <img src="{{asset('img/gallery/gallery_1_1.png')}}" alt="gallery image">
                        <a href="{{asset('img/gallery/gallery_1_1.png')}}" class="icon-btn popup-image"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xxl-auto col-lg-4 filter-item">
                <div class="gallery-card">
                    <div class="gallery-img">
                        <img src="{{asset('img/gallery/gallery_1_2.png')}}" alt="gallery image">
                        <a href="{{asset('img/gallery/gallery_1_2.png')}}" class="icon-btn popup-image"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xxl-auto col-lg-4 filter-item">
                <div class="gallery-card">
                    <div class="gallery-img">
                        <img src="{{asset('img/gallery/gallery_1_3.png')}}" alt="gallery image">
                        <a href="{{asset('img/gallery/gallery_1_3.png')}}" class="icon-btn popup-image"><i class="fas fa-eye"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xxl-auto col-lg-4 filter-item">
